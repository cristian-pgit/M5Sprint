...
/**
 * Servlet implementation class PUpdAdministrativo
 */
public class PUpdAdministrativo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public PUpdAdministrativo() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = getServletContext().getRequestDispatcher("/editarAdministrativo.jsp");
